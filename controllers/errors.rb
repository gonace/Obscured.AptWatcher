      ...
      class Errors < Obscured::AptWatcher::Controllers::Base
        ...
        get '/' do
          ...
          begin
            ...
            pagination_errors = Obscured::AptWatcher::Helpers::Pagination.new(errors, Obscured::AptWatcher::Models::Error.count)
        ...
        get '/:page' do
          ...
          begin
            ...
            pagination_errors = Obscured::AptWatcher::Helpers::Pagination.new(errors, Obscured::AptWatcher::Models::Error.count, page)
